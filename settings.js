...
const twsyncOutput = './public/app/mwsTest'; // default is './tiddlywiki/twsync'
const twmwsOutput = './public/mws'; // default is './tiddlywiki/twsync'

// er store and 'server' edition sync server TiddlyWikis
 ...
 ******************************************************************************/
    ...
    flowFile: (() => path.resolve('./flows/tiddlywiki.json'))(),
     ...
     * lost.
     */
    credentialSecret: "$2b$08$ZCVNHfiBHkyxAaoWop6gLOqeJ0qERLZDM2GN/8G.K5t9G/CyZtoxm",
     ...
     * Set to default nodes directory
     *
     * Note: TW5-Node-Red nodes are a dependency in './package.json'
     */
    nodesDir: (() => path.resolve('./nodes'))(),

/*******************************************************************************
 * TW5-Node-red
 *  - showWikiNodeStatus
 ******************************************************************************/
    /** Show status of 'get/set/dir' wiki node status. (handy for debuging)  **/
    showWikiNodeStatus: false,
 ...
 ******************************************************************************/
    ...
    // Full path to current directory's "public" subdirectory
    httpStatic: [
        {path: (() => path.resolve('./public/'))(), root: '/'},
    ],
 ...
 ******************************************************************************/
    ...
    editorTheme: {
        ...
        login: {
            image: (() => path.resolve('./public/tw5-node-red-login.png'))() // a 256x256 image
        },
        header: {
            title: "TW5-Node-RED",
            image: (() => path.resolve('./public/tw5-node-red-logo.png'))(),
            url: "http://localhost:1880/uibtw"
        },
        page: {
            title: "TW5-Node-RED",
            css: (() => path.resolve('./node-red-editor.css'))()
        },
            ...
            sources: [
                {
                    ...
                    path: (() => path.resolve('./lib/tw5-node-red/'))(),
                    label: "TW5-Node-Red",
                    icon: "font-awesome/fa-coffee"
                }
            ]
        }
