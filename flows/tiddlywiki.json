[
    ...
    },
    {
        ...
        "type": "group",
        "z": "304338a4b9f89088",
        "name": "Sent by client when HTML document 'onload' - determine if TW5 wiki or HTML page",
        "style": {
            "stroke": "#a4a4a4",
            "label": true,
            "label-position": "n"
    ...
    },
    {
        ...
        "type": "group",
        "z": "2e264bd071bbb666",
        "name": " \\n Fiona Solutions prototype \\n /svr/page/fiona \\n See ./uibulder/svr/src/pages/index.html",
        "style": {
            "label": true,
            "label-position": "n"
        },
    ...
    },
    {
        ...
        "z": "304338a4b9f89088",
        "g": "d57af1ba9d807a6e",
        "name": "HTML/TW5 Client?",
        "property": "network.meta.source",
        "propertyType": "msg",
        "rules": [
            {
                "t": "eq",
    ...
    },
    {
        ...
        "func": "const $tw = global.get('$twmws');\nconst mustache = global.get('mustache');\nconst store = $tw.mws.store;\n\nvar tiddlers = [];\n\nvar currentTiddler = msg.network.client.sender[0];\n\nvar recipeTiddlerList = store.getRecipeTiddlers(currentTiddler.recipe);\nrecipeTiddlerList.forEach(recipe => {\n    tiddlers.push(store.getRecipeTiddler(recipe.title, currentTiddler.recipe).tiddler)\n})\nmsg.payload = tiddlers; \n\nfor (let i=0; i<msg.payload.length; i++) {\n    if (msg.payload[i].text && msg.payload[i].mustache === 'yes') {\n        msg.payload[i].text = mustache.render(msg.payload[i].text, msg, {}, ['{%', '%}'])\n    }\n}\n\nreturn msg;",
        "outputs": 1,
        "timeout": 0,
        "noerr": 0,
        "initialize": "",
    ...
    },
    {
        ...
        "updtostory": true,
        "tostory": "true",
        "template": "title: Sample Web Page\n\n<iframe src=\"/svr/page/sample.html\" style=\"height:800px;width: 100%;\"/>\n",
        "clear": false,
        "editorIsOpen": true,
        "settingsIsOpen": false,
        "fromIsOpen": true,
